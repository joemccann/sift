...
public struct SetupFlowView: View {
    @ObservedObject private var viewModel: SiftViewModel
    ...
    public init(viewModel: SiftViewModel, isInitialLaunch: Bool) {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                VStack(alignment: .leading, spacing: 10) {
                    Text(isInitialLaunch ? "Welcome to Sift" : "Setup")
...
public struct SettingsPaneView: View {
    ...
    public init(viewModel: SiftViewModel) {
        self.viewModel = viewModel
    }
